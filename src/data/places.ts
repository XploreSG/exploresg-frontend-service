...
export const attractions: Place[] = [
  ...
  },
  {
    ...
    description:
      "Southeast Asia's premier natural history museum featuring dinosaur fossils and biodiversity exhibits.",
    image: "/assets/attractions/natural-history-museum.png",
    rating: 4.5,
    reviews: 6800,
    location: "Kent Ridge",
    category: "Museum",
    price: "S$16-21",
    coordinates: [103.7735, 1.3006],
  ...
  },
  {
    ...
    description:
      "Interactive science museum with over 1,000 exhibits, IMAX theatre, and engaging STEM activities.",
    image: "/assets/attractions/science-centre.png",
    rating: 4.4,
    reviews: 9200,
    location: "Jurong East",
    category: "Museum",
    price: "S$12-16",
    coordinates: [103.7358, 1.3336],
    address: "15 Science Centre Road, Singapore 609081",
  },
  {
    id: "attr-11",
    type: "attraction",
    name: "Snow City Singapore",
    description:
      "Singapore's first permanent indoor snow centre with snow play area, ice sculptures, and winter activities.",
    image: "/assets/attractions/snow-city.png",
    rating: 4.0,
    reviews: 4500,
    location: "Jurong East",
    category: "Entertainment",
    price: "S$18-25",
    coordinates: [103.7346, 1.3334],
  ...
  },
  {
    ...
    name: "Raffles Marina",
    description:
      "Premier waterfront destination with yacht club, seafood restaurants, and stunning marina views.",
    image: "/assets/attractions/raffles-marina.png",
    rating: 4.3,
    reviews: 3200,
    location: "Tuas",
    category: "Waterfront",
    price: "Free",
    coordinates: [103.6506, 1.2699],
  ...
  },
  {
    ...
    description:
      "Nature reserve with mangrove forests, mudflats, and diverse wildlife including migratory birds.",
    image: "/assets/attractions/sungei-buloh.png",
    rating: 4.6,
    reviews: 7800,
    location: "Kranji",
    category: "Nature",
    price: "Free",
    coordinates: [103.7297, 1.4454],
