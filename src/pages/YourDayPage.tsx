          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-4 rounded-2xl bg-white p-5 shadow">
              ...
              <div className="flex gap-4">
                <div className="flex-1">
                  <img
                    src="/assets/food/katong-laksa.jpg"
                    alt="328 Katong Laska"
                    className="mb-2 h-32 w-full rounded-lg object-cover"
                    style={{ aspectRatio: "1/1", objectPosition: "center center" }}
                    onError={(e) => {
                      (e.target as HTMLImageElement).src = "/assets/food/katong-laksa.jpg";
                    }}
                  />
                ...
                <div className="flex-1">
                  <img
                    src="/assets/food/maxwell-food-centre.jpg"
                    alt="Maxwell Food Centre"
                    className="mb-2 h-32 w-full rounded-lg object-cover"
                    style={{ aspectRatio: "1/1", objectPosition: "center center" }}
                    onError={(e) => {
                      (e.target as HTMLImageElement).src = "/assets/food/maxwell-food-centre.jpg";
                    }}
                  />
                  <div className="font-semibold text-gray-800">
                    Maxwell Food Centre
