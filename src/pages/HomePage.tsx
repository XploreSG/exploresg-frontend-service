  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="relative flex min-h-screen flex-col items-center justify-center px-4 pt-20 pb-24 sm:px-8">
        ...
        />
        {/* Gradient overlay */}
        <div className="absolute inset-0 -z-10 bg-gradient-to-tr from-white/80 via-purple-100/60 to-white/80" />
        {/* Announcement bar */}
        <div className="mb-6 flex items-center justify-center">
          <span className="rounded-full bg-white/80 px-4 py-1 text-xs font-medium text-gray-700 shadow">
            Discover Singapore, Your Way!
          </span>
        </div>
        {/* Headline */}
        <h1 className="mb-6 text-center text-4xl font-extrabold text-gray-900 drop-shadow-lg sm:text-5xl md:text-6xl">
          Explore Singapore
          <br className="hidden sm:block" /> with ExploreSG
        </h1>
        {/* Subheadline */}
        <p className="mb-8 max-w-2xl text-center text-lg text-gray-700">
          Welcome to ExploreSG, your platform to discover the best of Singapore.
          Dive into world-class attractions, vibrant local events, and hidden
          gems. Whether you’re a local or a visitor, find new adventures, food,
          and experiences that make Singapore truly special.
        </p>
        {/* CTA Buttons */}
